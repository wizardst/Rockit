...
typedef enum {
    MPP_REASON_UNKONW        = 0,
    MPP_DEC_INFO_CHANGE      = 1,
    MPP_DEC_STREAM_END       = 2,
    MPP_DEC_FMT_NOT_SUPPORT  = 3,
    MPP_REASON_BUTT
} MppCallBackReason;
...
RK_U32  mpp_frame_get_status(const MppFrame frame);
void    mpp_frame_set_status(MppFrame frame, RK_U32 status);
