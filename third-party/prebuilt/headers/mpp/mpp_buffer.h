...
#define mpp_buffer_get_cma_ion(group, buffer, size) \
        mpp_buffer_get_cma_ion_with_tag(group, buffer, size, MODULE_TAG, __FUNCTION__)

#define mpp_buffer_get_secure_ptr(buffer) \
        mpp_buffer_get_secure_ptr_with_caller(buffer, __FUNCTION__)
...
MPP_RET mpp_buffer_get_cma_ion_with_tag(MppBufferGroup group, MppBuffer *buffer, size_t size,
                                        const char *tag, const char *caller);

void   *mpp_buffer_get_secure_ptr_with_caller(MppBuffer buffer, const char *caller);
