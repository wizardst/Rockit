...
#define CMD_CTX_ID_SVP                  (0x00040000)
...
typedef enum {
    ...
    MPP_DEC_GET_DECODED_PACKET_COUNT,           /*get decoded packet number*/
    MPP_DEC_SET_SECURE_CONTEXT,
    MPP_DEC_GET_DPB_SIZE,
    ...
    MPP_ENC_SET_ROI,                    /* for H265 Encoder,set ROI's size and QP */
    MPP_ENC_CMD_END,

    MPP_ISP_CMD_BASE                    = CMD_MODULE_CODEC | CMD_CTX_ID_ISP,
    MPP_ISP_CMD_END,

    MPP_SVP_CMD_BASE                    = CMD_MODULE_CODEC | CMD_CTX_ID_SVP,
    MPP_SVP_SECURE_MEMCOPY,
    MPP_SVP_CMD_END,
