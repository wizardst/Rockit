...
#ifndef SRC_RT_MEDIA_RTOSSINK_ANDROID_RTAWINDOWSINK_H_
#define SRC_RT_MEDIA_RTOSSINK_ANDROID_RTAWINDOWSINK_H_
...
#endif  // SRC_RT_MEDIA_RTOSSINK_ANDROID_RTAWINDOWSINK_H_
