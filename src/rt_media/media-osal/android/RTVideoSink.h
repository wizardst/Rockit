...
#ifndef SRC_RT_MEDIA_MEDIA_OSAL_ANDROID_RTVIDEOSINK_H_
#define SRC_RT_MEDIA_MEDIA_OSAL_ANDROID_RTVIDEOSINK_H_
...
#endif  // SRC_RT_MEDIA_MEDIA_OSAL_ANDROID_RTVIDEOSINK_H_
