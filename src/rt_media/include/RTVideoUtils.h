...
#ifndef SRC_RT_MEDIA_INCLUDE_RTVIDEOUTILS_H_
#define SRC_RT_MEDIA_INCLUDE_RTVIDEOUTILS_H_
...
typedef enum {
     ...
     RT_VIDEO_CodingKhronosExtensions = 0x6F000000,

     /* *< Reserved region for introducing Vendor Extensions */
     RT_VIDEO_CodingVendorStartUnused = 0x7F000000,
     RT_VIDEO_CodingMax = 0x7FFFFFFF
}RtCodingType;

#endif  // SRC_RT_MEDIA_INCLUDE_RTVIDEOUTILS_H_
