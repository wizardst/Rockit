...
RT_RET unit_test_linked_list(INT32 index, INT32 total_index) {
    ...
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 234))), 234);
    ...
    */
    ...
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 233))), 233);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 234))), 1001);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 235))), 1000);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 236))), 234);
    ...
    */
    ...
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 234))), 234);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 235))), 235);
    ...
    */
    ...
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 234))), 236);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 235))), 237);
    ...
    */
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 234))), 238);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 235))), 239);
    ...
    */
    ...
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 0))), 1);
    CHECK_EQ(*(reinterpret_cast<INT32 *>(linked_list_get_data(rt_list, 993))), 998);
