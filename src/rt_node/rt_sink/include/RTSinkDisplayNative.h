...
#ifndef SRC_RT_NODE_RT_SINK_INCLUDE_RTSINKDISPLAYNATIVE_H_
#define SRC_RT_NODE_RT_SINK_INCLUDE_RTSINKDISPLAYNATIVE_H_
...
#endif  // SRC_RT_NODE_RT_SINK_INCLUDE_RTSINKDISPLAYNATIVE_H_
